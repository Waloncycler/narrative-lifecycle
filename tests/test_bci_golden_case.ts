...
describe('test_bci_golden_case', () => {
  ...
  available_at: '2026-01-04',
        ...
        source_name: 'second independent regulator',
      ...
      {
        evidence_id: 'bci_branch_reality_2',
        topic_id: 'bci',
        branch_id: 'bci_medical_rehab',
        event_date: '2026-06-25T00:00:00.000Z',
        available_at: '2026-06-26T00:00:00.000Z',
        event_title: 'Title 2',
        event_type: 'regulatory_approval',
        source_name: 'third independent regulator',
        evidence_strength: 'E3',
        affected_layer: ['reality'],
        stage_effect: 'supports_branch_S6',
        parent_or_branch: 'branch',
      ...
      {
        evidence_id: 'bci_branch_reality_3',
        topic_id: 'bci',
        branch_id: 'bci_medical_rehab',
        event_date: '2026-06-25T00:00:00.000Z',
        available_at: '2026-06-26T00:00:00.000Z',
