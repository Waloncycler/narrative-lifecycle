import type { EvidenceImportDraft, EvidenceValidationReport } from './evidence_import';
import type { StageDiff, StageSnapshotHistory } from './diff';
import type { WeeklyBrief } from './report';
...
export interface AutonomousResearchRun {
  ...
  graph_promotion: import('./narrative_graph_promotion').NarrativeGraphPromotionReport;
