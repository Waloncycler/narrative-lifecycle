...
console.log(JSON.stringify({ retrieval_run_id: report.retrieval_run_id, requested: report.requested_count, retrieved: report.retrieved_count, skipped: report.skipped_count, failed: report.failed_count, json: 'outputs/research/latest_source_retrieval.json', quality: 'outputs/research/latest_source_quality.json' }, null, 2));
