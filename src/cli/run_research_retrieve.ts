...
console.log(JSON.stringify({ retrieval_run_id: report.retrieval_run_id, requested: report.requested_count, retrieved: report.retrieved_count, skipped: report.skipped_count, failed: report.failed_count, json: '<stored in db>', quality: '<stored in db>' }, null, 2));
