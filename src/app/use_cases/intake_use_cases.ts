import {
  ...
  noTradingAdvice,
  reviewTemplate,
} from '@/features/intake/domain/intake_rules';
import { buildIntakeEvaluation } from '@/features/intake/domain/intake_evaluation';
import { buildTopicResolutionAudit } from '@/features/narrative/domain/topic_resolver';
import type { EvidenceImportDraft, EvidenceImportReport } from '@/features/evidence/types/evidence_import';
import type { AiCandidateSuggestion, EvidenceIntakeApplyResult, EvidenceIntakeSession, IntakeEvaluationReport, RawDocument, ReviewDecision } from '@/features/intake/types/intake';
import type { RunManifest } from '@/platform/types/run_context';
import type { TopicRegistry, TopicResolutionAudit, TopicRegistryValidationReport } from '@/features/narrative/types/topic_resolution';
import { compareRuleAndAiCandidates } from '@/features/intake/domain/intake_evaluation';
import { buildAiShadowValidationReport } from '@/features/research/domain/ai_shadow_validation';
...
export interface BuildIntakeLearningCycleUseCaseDeps {
  ...
  readTopicResolutionAudit(): TopicResolutionAudit | null;
  readAiShadowValidationReport(): import('@/features/intake/types/intake').AiShadowValidationReport | null;
