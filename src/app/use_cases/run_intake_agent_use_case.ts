import { buildAgentVerificationReport, mergeAgentOnlyCandidates } from '@/features/intake/domain/intake_agent_rules';
...
import type { IntakeAgentAudit, IntakeAgentReviewBundle, AgentEvidenceCandidate } from '@/features/intake/types/intake_agent';
...
import { applyNarrativeDiscoveryMappings, discoverNarrativeGraph } from '@/features/narrative/domain/narrative_discovery';
...
export interface RunIntakeAgentUseCaseDeps {
  ...
  readTopicResolutionAudit(): import('@/features/narrative/types/topic_resolution').TopicResolutionAudit | null;
