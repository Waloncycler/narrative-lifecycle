...
import type { PilotLedgerEntry, PilotObservation, PilotResearchLedger, PilotTopic } from '@/features/reporting/types/pilot';
...
import {
  ...
  pilotActionFor,
  validatePilotTopic,
} from '@/features/reporting/domain/pilot_rules';
