...
import { ApplyEvidenceIntakeReviewUseCase, BuildIntakeLearningCycleUseCase, BuildIntakeLearningProfileUseCase, EvaluateIntakeUseCase, PrepareEvidenceIntakeUseCase, RetryEvidenceIntakePipelineUseCase, RunAiShadowCorpusEvaluationUseCase, RunAiShadowValidationUseCase, ValidateTopicsUseCase } from '../application/use_cases/intake_use_cases';
...
import type { AiShadowValidationReport, EvidenceIntakeSession } from '../types/intake';
import type { NarrativeDiscoveryReport } from '../types/narrative_discovery';
...
import { FileIntakeRepository } from './intake_io';
import { renderIntakeWorkbench } from '../interface/intake_workbench_renderer';
import { FileTopicRegistryRepository, ShadowAiCandidateGenerator } from './topic_registry_io';
import { aiShadowConfigFromEnv, ProviderNeutralAiShadowAdapter } from './ai_shadow_provider';
import { RunIntakeAgentUseCase } from '../application/use_cases/run_intake_agent_use_case';
import { intakeAgentConfigFromEnv, OpenAiCompatibleIntakeAgentAdapter } from './intake_agent_provider';
import { FileIndustryPackRepository } from './industry_pack_io';
...
import { FileWorldMonitorSourceRepository, WorldMonitorHttpClient } from './worldmonitor_source_adapter';
...
import { FileIntelligenceRepository } from './intelligence_io';
import { ResearchAgentScheduler } from './research_agent_scheduler';
import { FileResearchAgentRepository } from './research_agent_io';
import { FileAutonomousResearchRepository } from './autonomous_research_io';
...
import { FileWebResearchRepository } from './web_research_io';
import { HttpWebSearchProvider, webSearchConfigFromEnv } from './web_search_provider';
import { FileResearchCoverageRepository } from './research_coverage_io';
import { BuildResearchCampaignUseCase } from '../application/use_cases/build_research_campaign_use_case';
...
import { AuthoritativeDirectSourceProvider } from './authoritative_direct_source_provider';
import { PrepareDirectSourceIntakeUseCase } from '../application/use_cases/prepare_direct_source_intake_use_case';
import { BuildResearchLeadTriageUseCase } from '../application/use_cases/build_research_lead_triage_use_case';
import { FileResearchLeadTriageRepository } from './research_lead_triage_io';
import { RetrieveResearchSourcesUseCase } from '../application/use_cases/retrieve_research_sources_use_case';
import { FileResearchSourceRetrievalRepository, HttpResearchSourceRetriever } from './research_source_retrieval_io';
import { BuildResearchBaselineCompletionUseCase } from '../application/use_cases/build_research_baseline_completion_use_case';
import { FileResearchBaselineCompletionRepository } from './research_baseline_completion_io';
