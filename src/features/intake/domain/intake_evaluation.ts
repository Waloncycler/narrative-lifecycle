...
import type { AiCandidateSuggestion, CandidateGenerationComparison, CandidateReviewFeedback, EvidenceCandidate, EvidenceIntakeApplyResult, EvidenceIntakeSession, IntakeEvaluationReport, ReviewDecision } from '@/features/intake/types/intake';
import { noTradingAdvice } from '@/features/intake/domain/intake_rules';
