...
import type { ScoreDetails, ScoreResult } from '@/features/scoring/domain/scoring';
import { calculateDataConfidence } from '@/features/stages/rules/data_confidence_rules';
import { scoreFromEvidence } from '@/features/scoring/rules/scoring_rules';
import { maxAllowedStage } from '@/features/stages/rules/stage_gate_rules';
import { stageRank } from '@/features/stages/domain/stages';
...
import { inferStageGateInput, toStageSnapshot, type StageClassification } from '@/features/stages/domain/stage_classifier';
