...
import type { AiCandidateSuggestion, AiShadowAuditRecord, EvidenceIntakeSession } from '@/features/intake/types/intake';
import { AI_SHADOW_PROMPT_VERSION, fallbackAiCandidate, withAiValidation } from '@/features/research/domain/ai_shadow_validation';
