...
export function renderSources(model: NarrativeMonitorModel): string {
  ...
  const portalUrlMap: Record<string, string> = {
    gdelt_doc_articles: 'https://www.gdeltproject.org/',
    coinbase_spot: 'https://www.coinbase.com/explore',
    eastmoney_concept_boards: 'https://data.eastmoney.com/bkzj/',
    eastmoney_stock_quote: 'https://quote.eastmoney.com/',
    eastmoney_reports: 'https://data.eastmoney.com/report/',
    clinical_trials_gov: 'https://clinicaltrials.gov/',
    un_comtrade_preview: 'https://comtradeplus.un.org/',
    sec_edgar_nvidia: 'https://www.sec.gov/edgar/browse/?CIK=0001045810',
    sec_edgar_apple: 'https://www.sec.gov/edgar/browse/?CIK=0000320193',
    sec_edgar_tsmc: 'https://www.sec.gov/edgar/browse/?CIK=0001046179',
    hacker_news_stories: 'https://news.ycombinator.com/',
    fear_greed_index: 'https://alternative.me/crypto/fear-and-greed-index/',
    coingecko_trending: 'https://www.coingecko.com/en/watchlists/trending-crypto',
    cailian_telegraph: 'https://www.cls.cn/telegraph',
    wsj_business: 'https://www.wsj.com/business',
    reuters_biz: 'https://www.reuters.com/business/',
    tech_crunch: 'https://techcrunch.com/',
    nts_finance: 'https://www.caixin.com/finance/',
    nts_technology: 'https://www.caixin.com/tech/',
    nts_etf: 'https://quote.eastmoney.com/center/gridlist.html#etf_board',
    nts_research: 'https://data.eastmoney.com/report/',
    investing_macro: 'https://cn.investing.com/economic-calendar/',
    investing_stock: 'https://cn.investing.com/equities/',
    investing_analysis: 'https://cn.investing.com/analysis/',
    investing_crypto: 'https://cn.investing.com/crypto/',
    huggingface: 'https://huggingface.co/models',
    github_issues: 'https://github.com/trending',
    ...
    deepseek_updates: 'https://www.deepseek.com/',
    xai_releases: 'https://x.ai/',
    gov_cn: 'https://www.gov.cn/zhengce/',
    ndrc_policy: 'https://www.ndrc.gov.cn/xwdt/tzgg/',
    ccgp_central_tenders: 'http://www.ccgp.gov.cn/cggg/dfgg/zbgg/',
    ccgp_central_awards: 'http://www.ccgp.gov.cn/cggg/dfgg/zbgg/',
    state_grid_procurement: 'https://ecp.sgcc.com.cn/',
    csg_enterprise_procurement: 'https://www.bidding.csg.cn/',
    nha_disease_outbreaks: 'http://www.nhc.gov.cn/',
    samr_consumer_safety: 'https://www.samr.gov.cn/',
    mofcom_supply_price: 'http://www.mofcom.gov.cn/',
    cninfo_disclosures: 'http://www.cninfo.com.cn/new/index',
    cninfo_announcements: 'http://www.cninfo.com.cn/new/index',
    sse_announcements: 'http://www.sse.com.cn/disclosure/listedinfo/announcement/',
    szse_announcements: 'http://www.szse.cn/disclosure/listed/notice/index.html',
    hkex_news: 'https://www.hkexnews.hk/',
    csrc_announcements: 'http://www.csrc.gov.cn/',
    nmpa_cde: 'http://www.cde.org.cn/',
    caac_evtol: 'http://www.caac.gov.cn/',
    nea_energy: 'http://www.nea.gov.cn/',
    cnipa_patents: 'https://www.cnipa.gov.cn/',
    uspto_patents: 'https://www.uspto.gov/',
    wipo_patents: 'https://www.wipo.int/patents/en/',
    nature_electronics: 'https://www.nature.com/natelectron/',
    science_robotics: 'https://www.science.org/journal/scirobotics',
    pubmed_nih: 'https://pubmed.ncbi.nlm.nih.gov/',
    semianalysis_intel: 'https://www.semianalysis.com/',
    the_information: 'https://www.theinformation.com/',
    pitchbook_deals: 'https://pitchbook.com/',
    xueqiu_institutional: 'https://xueqiu.com/',
    vip_leaders_stream: 'https://blogs.nvidia.com/',
    fed_statements: 'https://www.federalreserve.gov/newsevents/pressreleases.htm',
    pboc_announcements: 'http://www.pbc.gov.cn/goutongjiaoliu/113456/113469/index.html',
    bdi_index: 'https://cn.investing.com/indices/baltic-dry',
    '36kr': 'https://36kr.com/',
    jiqizhixin: 'https://www.jiqizhixin.com/',
    qbitai: 'https://www.qbitai.com/',
    people_daily_headlines: 'http://paper.people.com.cn/',
  };
  ...
  const roster = catalogEntries.map((cat) => {
    ...
    const humanUrl = portalUrlMap[cat.source_id] || matchedOp?.governance?.terms_url || matchedOp?.production_url || 'https://www.gov.cn/';
    return {
      id: cat.source_id,
...
function stageClass(stage: string): string {
  if (stage.startsWith('S0')) return 'stage-s0';
  if (stage.startsWith('S1')) return 'stage-s1';
  if (stage.startsWith('S2')) return 'stage-s2';
  if (stage.startsWith('S3')) return 'stage-s3';
  if (stage.startsWith('S4')) return 'stage-s4';
  if (stage.startsWith('S5')) return 'stage-s5';
  if (stage.startsWith('S6')) return 'stage-s6';
  if (stage.startsWith('S7A')) return 'stage-s7a';
  if (stage.startsWith('S7B')) return 'stage-s7b';
  if (stage.startsWith('S7C')) return 'stage-s7c';
  if (stage.includes('S7')) return 'stage-s7';
  return 'stage-s0';
}
