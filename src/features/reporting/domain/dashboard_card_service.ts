import type { ScoreDetails } from '@/features/scoring/domain/scoring';
import { maxStageInExpression, stageRank, type StageSnapshot } from '@/features/stages/domain/stages';
import { maximumStageByDataConfidence } from '@/features/stages/rules/data_confidence_rules';
