...
import { maxStageInExpression } from '@/features/stages/domain/stages';
...
import { classifyStage, type StageClassification } from '@/features/stages/domain/stage_classifier';
