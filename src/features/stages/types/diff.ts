import type { ResearchSafeActionVerb, WeeklyBriefGuardrailCheck } from '@/features/reporting/types/report';
import type { ArtifactMetadata } from '@/platform/types/artifact_contract';
...
export interface StageSnapshotTopic {
  ...
  gate_input?: import('@/features/stages/domain/stages').StageGateInput;
  evidence_ids: string[];
  score_id: string;
