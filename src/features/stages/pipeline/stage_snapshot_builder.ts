import type { DataConfidenceBand, StageSnapshotHistory } from '@/features/stages/types/diff';
import type { RunContext } from '@/platform/types/run_context';
import { artifactMetadata } from '@/platform/types/artifact_contract';
import type { DiffArtifacts } from '@/features/stages/pipeline/diff_artifact_loader';
